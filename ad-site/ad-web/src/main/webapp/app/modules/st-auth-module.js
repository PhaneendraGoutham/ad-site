angular.module('st-auth-module', ['ngCookies','angularLocalStorage','st-common-module']).provider('Auth', function() {
    var self = this;
...
//            },
    ...
    this.$get = ['Auth','$q','$location','$log','CommonFunctions',function(Auth, $q, $location, $log, CommonFunctions) {
...
// base64 characters are A-Z, a-z, 0-9, '+', '/',and '='\n" + "Expect errors in
// decoding.");
// }
