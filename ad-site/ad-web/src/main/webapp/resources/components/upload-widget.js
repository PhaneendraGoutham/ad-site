 ...
 * -------- -------- -------- -------- -------- -------- -------- --------
 * SWFUpload is (c) 2006 Lars Huring, Olov NilzĂŠn and Mammon Media and is released under the MIT License:
      ...
      this.uploadError = function(fileObj, errorCode, message) {
        ...
        switch (errorCode) {
          ...
          case SWFUpload.UPLOAD_ERROR.IO_ERROR:
            code = 'IO_ERROR';
            error = 'Connection interrupted. This error may be caused by intermittent connection loss, local firewall software, or issues with your network configuration. Please try your upload again or contact support@wistia.com for assistance.';
            $upload_status.addClass('error').html(error);
            break;
...
//        }
        ...
        var buttonText = o['buttonText'] || 'Upload Media';
        $uw.append('<div class="upload-button btn btn-success btn-sm">' + buttonText + '</div>');
