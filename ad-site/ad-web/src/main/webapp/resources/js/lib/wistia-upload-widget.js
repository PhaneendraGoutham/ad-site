  ...
  var Wistia = function() {
    ...
    this.UploadWidget = function(o) {
      ...
      this.uploadProgress = function(fileObj, bytesLoaded) {
        ...
        notify('uploadProgress', [ bytesLoaded, self.totalBytesLeft ]);
      };
...
//        $uw.append('<div class="wistia-upload-button button-green"><a class="upload-media" href="#" style="color:#ffffff">' + buttonText + '</a></div>');
        ...
        $uw.append(
          	...
          	'</div>' +
          	'<a class="cancel" href="#" title="Cancel Upload"></a>' +
          '</div>');

        $upload_button = self.jq(self.divSelector + ' .wistia-upload-button');
